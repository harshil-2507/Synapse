        ...
        <div style={{ padding: "32px 36px 24px", position: "relative" }}>
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start", justifyContent: "space-between", gap: 24 }}>
            <div>
              ...
              <p style={{ color: "rgba(216,180,254,0.7)", fontSize: 13, lineHeight: 1.65, margin: 0, maxWidth: 460, marginTop: 8 }}>
                Integrates geopolitical risk modeling as a first-class signal layer, enabling forecasts that dynamically adjust for regional instability, conflict intensity, sanctions exposure, and macro-political shocks across global markets.
              </p>
            </div>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                {[
                  ...
                  { icon: "M12 2a10 10 0 100 20 10 10 0 000-20zm0 5c.6 0 1 .4 1 1v4c0 .6-.4 1-1 1s-1-.4-1-1V8c0-.6.4-1 1-1zm0 10a1.5 1.5 0 110-3 1.5 1.5 0 010 3z", label: "Geopolitical Risk Analysis" }
                ].map(f => (
